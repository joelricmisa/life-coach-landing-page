	...
	return (
		<section>
			<div className="flex flex-col lg:h-screen gap-10 lg:gap-0  lg:flex-row ">
				<div className="md:px-20 px-10 py-24 flex justify-center items-center h-full flex-col gap-10 bg-hero bg-cover bg-no-repeat bg-bottom lg:bg-center lg:basis-8/12">
				...
				<img
					...
					className="lg:basis-4/12  md:h-[805px] md:w-[650px] mx-auto"
				/>
			</div>
		</section>
	);
